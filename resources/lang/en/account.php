<?php
return [
    'home_title' => 'Administration of your LaunchHR account',
    ...
    'employees_invite_title' => 'Invite {name} to become a user of LaunchHR',
    'employees_invite_description' => '{firstname} has a profile on LaunchHR, but needs to create an account in order to participate.',
    ...
    'employee_delete_description' => 'You are about to remove {name} from LaunchHR. This will effectively delete all information we know about this person. We will revoke all possible access to LaunchHR immediately.',
    ...
    'teams_blank' => 'Teams are a great way for groups of people in your company to work together in LaunchHR.',
    ...
    'cancel_account_thanks' => 'Thanks for giving LaunchHR a try!',
