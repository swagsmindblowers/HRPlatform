...
class AcceptExpenseAsAccountant extends BaseService
{
    ...
    /**
     * Accept the expense as the accountant.
     *
     * @param array $data
     * @return Expense
     */
    ...
    {
        $this->expense->status = Expense::ACCEPTED;
    ...
    private function notifyEmployee()
    {
        ...
        NotifyEmployee::dispatch([
            ...
            'action' => 'expense_accepted_by_accounting',
            'objects' => json_encode([
    ...
    private function log(): void
    {
        ...
        LogEmployeeAudit::dispatch([
            ...
            'action' => 'expense_accepted_by_accounting_for_employee',
            'author_id' => $this->author->id,
            'author_name' => $this->author->name,
            'audited_at' => Carbon::now(),
            'objects' => json_encode([
