...
return [
    ...
    'release' => trim(is_file(__DIR__.'/.release') ? file_get_contents(__DIR__.'/.release') : (is_dir(__DIR__.'/../.git') ? trim((string) exec('git --git-dir '.base_path('.git').' log --pretty="%h" -n1 HEAD')) : '')),
